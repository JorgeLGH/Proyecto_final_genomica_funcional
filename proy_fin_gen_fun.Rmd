...
```{r}
#primero vamos a cargar las librerías que se requieren
library(phyloseq)
library(Biostrings)
library(ggplot2)
...
```{r}
library(knitr)
include_graphics("~/R/Genomica_funcional/pro_fin_genfun/error_1.png")
include_graphics("~/R/Genomica_funcional/pro_fin_genfun/comunidades_art.jpg")
```
